        ...
        if (scored) {
          return (
            <span key={index} className="relative inline-block mx-1">
              <span
                className="px-3 py-1 text-[#1C1C1C] font-bold shadow-[4px_4px_0px_rgba(28,28,28,0.5)] animate-word-flash relative z-10 rounded-[2px]"
                style={{ backgroundColor: scored.cursor.color }}
              >
                {word}
              </span>
              <div className="absolute top-full left-1/2 transform -translate-x-1/2 flex flex-col items-center animate-points-drop z-20 pointer-events-none mt-2">
                <div
                  ...
                  style={{ borderBottomColor: scored.cursor.color }}
                ></div>
                <span
                  className="font-pixel text-xl md:text-2xl font-bold whitespace-nowrap bg-[#1C1C1C] px-2 py-1 shadow-[4px_4px_0px_rgba(0,0,0,0.5)] border rounded-[2px]"
                  style={{
                    color: scored.cursor.color,
                    borderColor: scored.cursor.color,
                  }}
                >
                  +{scored.count * 100} PTS
                </span>
                <span className="font-pixel text-xs bg-[#1C1C1C] text-[#F7F5F0] px-1 mt-1 border border-[#333] tracking-widest uppercase">
                  (x{scored.count} votos - {scored.type})
                </span>
              </div>
            </span>
          );
